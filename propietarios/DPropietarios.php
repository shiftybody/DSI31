...
<div class="flex flex-col  items-center">
    <div class="py-8" >
<form action="DPropietarios.php" method="GET" class="flex justify-center items-end ">
    <div class="mr-3">
        <label for="" class="label-form">RFC del Propietario</label>
        <input type="text" name="Criterio" id="Criterio" class="input-form" value="<?php isset($_GET['RFC']) ? print($_GET['RFC']) : null?>"  required></input>
    </div>
    <div classs="mr3">
    ...
    <div class="flex flex-col justify-center items-center hidden" id="alert">
        ...
        <a class="font-bold mt-2 text-red-600 hover:drop-shadow-xl" href="./SPropietarios.php">
              Ir a Consultar 
        </a>
    </div>
</div>
