...
<div class="flex flex-col  items-center">
    <div class="py-8" >
<form action="DConductores.php" method="GET" class="flex justify-center items-end ">
    <div class="mr-3">
    ...
    <div class="flex flex-col justify-center items-center hidden" id="alert">
        ...
        <a class="font-bold mt-2 text-red-600 hover:drop-shadow-xl" href="./SConductores.php">
              Ir a Consultar 
        </a>
    </div>
</div>
