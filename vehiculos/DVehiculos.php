...
<div class="flex flex-col  items-center">
    <div class="py-8" >
<form action="DVehiculos.php" method="GET" class="flex justify-center items-end ">
    <div class="mr-3">
        <label for="" class="label-form">NIV del Vehiculo</label>
        <input type="text" name="Criterio" id="Criterio" class="input-form" value="<?php isset($_GET['NIV']) ? print($_GET['NIV']) : null?>"  required></input>
    </div>
    <div classs="mr3">
