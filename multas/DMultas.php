...
<div class="flex flex-col  items-center">
    <div class="py-8" >
<form action="DMultas.php" method="GET" class="flex justify-center items-end ">
    <div class="mr-3">
        <label for="" class="label-form">ID de la Multa</label>
        <input type="text" name="Criterio" id="Criterio" class="input-form" value="<?php isset($_GET['IDMulta']) ? print($_GET['IDMulta']) : null?>"  required></input>
    </div>
    <div classs="mr3">
    ...
    <div class="flex flex-col justify-center items-center hidden" id="alert">
        ...
        <a class="font-bold mt-2 text-red-600 hover:drop-shadow-xl" href="./SMultas.php">
              Ir a Consultar 
        </a>
    </div>
</div>
